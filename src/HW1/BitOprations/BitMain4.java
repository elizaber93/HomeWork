...
public class BitMain4 {
    public static void main(String[] args) {
        ...
        System.out.println("a^b = " + result + " = 0b" + Integer.toBinaryString(result));   //a^b = 37 = 0b100101
        ...
        System.out.println("negA^negB = " + result + " = 0b" + Integer.toBinaryString(result)); //negA^negB = 39 = 0b100111
    }
}
