...
public class ArraysMain2_1 {
    public static void main(String[] args) {
        int[] array1 = {20, 1, -1, 2, -2, 3, 3, 5, 5, 1, 2, 4, 20, 4, -1, -2, 5, 5};
    ...
    public static int repetitionSearch(int[] a) {
        for (int i = 0, repCount = 0; i < a.length; i++, repCount = 0) {
            for (int value : a) {
                repCount = (a[i] == value) ? ++repCount : repCount;
            }
            if (repCount % 2 != 0) {
